...
class TaskListPage extends StatelessWidget {
  ...
  Widget _buildTaskTile(BuildContext context, TaskModel task, Color color) {
    return ListTile(
      ...
      subtitle: Text(
          '${DateFormat('dd/MM/yyyy').format(task.assignDate)} - ${DateFormat('dd/MM/yyyy').format(task.dueDate)}'),
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Container(
          ...
          child: ConstrainedBox( // Use ConstrainedBox
          constraints: BoxConstraints.expand(), // Expand to fill the Container
          child: Card(
